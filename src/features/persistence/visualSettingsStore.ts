...
export function hydrateVisualSettings(
  ...
  return {
    ...
    desktop: {
      ...
      dockTintColor: source?.desktop?.dockTintColor || '#f8fafc',
      dockTintOpacity: source?.desktop?.dockTintOpacity ?? 0.18,
    ...
    chat: {
      ...
      avatarFrameCss: source?.chat?.avatarFrameCss || '',
      modelAvatarFrameCss: source?.chat?.modelAvatarFrameCss || '',
      userAvatarFrameCss: source?.chat?.userAvatarFrameCss || '',
    ...
    dynamics: {
      ...
      profileNameColor: source?.dynamics?.profileNameColor || '',
      profileNameFontFamily: source?.dynamics?.profileNameFontFamily || '',
      profileMoodColor: source?.dynamics?.profileMoodColor || '',
      profileMoodFontFamily: source?.dynamics?.profileMoodFontFamily || '',
