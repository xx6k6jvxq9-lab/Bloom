...
export function buildDreamNarrativePrompt(options: BuildDreamNarrativePromptOptions) {
  ...
  const narrativeQualityRules = [
    ...
    'Use at least 2 non-narration blocks that fit the chosen layout, but keep most blocks as novel-like narration. The page should feel designed, not like every paragraph is a bubble.',
