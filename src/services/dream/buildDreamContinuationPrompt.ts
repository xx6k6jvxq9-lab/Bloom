...
export function buildDreamContinuationPrompt(options: GenerateDreamContinuationOptions) {
  ...
  const novelQualityRules = [
    ...
    'Each generated act should use 2-3 non-narration narrative blocks that fit the existing layout. Keep most blocks novel-like narration; do not turn every paragraph into a bubble or design card.',
