...
export function MallQuickEntry({
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className="min-w-[74px] rounded-[16px] border border-zinc-100 bg-white px-4 py-3 text-left"
    >
...
export function MallProductCard({
  ...
  return (
    <div className="overflow-hidden rounded-[22px] border border-zinc-100 bg-white shadow-[0_14px_30px_rgba(15,23,42,0.04)]">
      <button type="button" onClick={onOpen} className="block w-full text-left p-2.5">
      ...
      <div className="space-y-2 px-3.5 pb-3.5">
        ...
        <div className="flex items-center justify-between gap-3">
          ...
          <button
            type="button"
            onClick={onAddToCart}
            className="rounded-full bg-[#f4dbe1] px-3 py-2 text-[11px] font-semibold text-[#764e60]"
          >
            加入
          </button>
        </div>
...
export function MallCategoryShortcut({
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className="flex flex-col items-center rounded-[18px] bg-white px-3 py-4 text-center shadow-sm transition hover:bg-zinc-50"
    >
        ...
        <div className="flex items-start justify-between gap-4">
          <div className="min-w-0 flex-1">
            ...
            <button
              ...
              className="mt-4 rounded-full bg-white/90 px-4 py-2 text-[12px] font-semibold text-zinc-700"
            >
