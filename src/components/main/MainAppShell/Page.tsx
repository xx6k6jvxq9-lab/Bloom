...
export function MainApp({ 
  ...
  const mainHeaderTopPadding = 'calc(env(safe-area-inset-top, 0px) + 12px)';
  const mainQuickActionsTop = 'calc(env(safe-area-inset-top, 0px) + 62px)';
  ...
  const header = !(activeTab === 'me' && meSection !== 'main') ? (
    <div
      ...
      style={{ paddingTop: mainHeaderTopPadding }}
    >
