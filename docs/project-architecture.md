...
- ��ǰ�Դ��ڽ׶� B �к�Σ���ս���� `B4 ���� OOC ����`
- `Boundary Pack` �Ѿ����ĵ�����������ṹ������û����������������տ�
- ��ǰ����Ŀ�겻�Ǽ�����������ɫ�İ������ǰѱ߽���ȶ������������
...
- ��ɫ�ṹ���Ѿ��У�
  ...
  - `boundaryPack`
  - `remarkName`
  - λ�ü� [`src/types.ts`](../src/types.ts)
- ��ɫ�������Ѿ���ʽ�����
  - `corePersona`
  - `expressionStyle`
  - `boundaryPack`
  - λ�ü� [`src/services/relationship-context/buildCharacterContext.ts`](../src/services/relationship-context/buildCharacterContext.ts)
- ����ҳ�Ѿ�����ʽ�༭��ڣ�
  - ��ע
  - ����ǩ��
  - ��������
  - ���������ദ��ʽ
  - �߽������
  - λ�ü� [`src/components/chat/ChatSettingsPanel.tsx`](../src/components/chat/ChatSettingsPanel.tsx)
- ������ɫҳ�Ѿ�ͬ���������Ͻṹ��
  - ֧�� `remarkName`
  - ֧�ָ���ǩ��
  - ��ɫ�趨�·��С���д�����趨����������������ϸ��������ʾ
  - λ�ü� [`src/App.tsx`](../src/App.tsx)
- ��ע��ʾ���Ѿ������Ƶ��ͼ��
  - ����ҳ����
  - �����б�
  - ͨѶ¼�б�/����
  - λ�ü� [`src/services/chat/messageActions.ts`](../src/services/chat/messageActions.ts)
  - �Լ� [`src/components/main/MainAppShell/Page.tsx`](../src/components/main/MainAppShell/Page.tsx)
  - �Լ� [`src/components/main/ContactsShell/Page.tsx`](../src/components/main/ContactsShell/Page.tsx)

### Boundary Pack ��ǰ����״̬

- �����ѽ��� `boundaryPack`
  - λ�ü� [`src/services/scene-inputs/buildChatSceneInput.ts`](../src/services/scene-inputs/buildChatSceneInput.ts)
- Լ���ѽ��� `boundaryPack`
  - λ�ü� [`src/services/scene-inputs/buildDatingSceneInput.ts`](../src/services/scene-inputs/buildDatingSceneInput.ts)
- Ⱥ���ڵ�ǰ���������н��߸Ķ���������Ӧ��Ϊ�ȶ����߽���
  - ��Ҫ��������֤ͨ��������ʽȷ��
- `couple-space` ���������Ŀǰ��û����ʽ���� `boundaryPack`
