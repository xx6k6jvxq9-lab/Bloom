...
- [x] 群系统消息乱码修复：群创建 / 入群 / 改群名 / 改群公告 / 改群头像等系统 notice 已恢复正常中文
- [x] 群成员权限骨架落地：群主 / 管理员 / 普通成员
- [x] 公开认识与群内公开连续性已开始从“私有关系余波”中拆分出来，保留“进群后认识彼此”的真实感
- [x] 表情包主链第一版收口：单聊 / 群聊正常发图、共享表情包、批量导入、多链接导入、外框移除
- [x] 群投票第一版正式落地：独立投票卡片、真实选项、AI 成员参与投票、票数与结束态
- [x] 群接龙第一版正式落地：用户起头、卡片发起、AI 成员按人设与记忆接续、结束态
- [x] 群小任务第一版正式落地：任务卡发起、成员用正常群消息气泡参与、多轮推进与结束态
- [x] 群功能入口正式接入群聊底部扩展面板，群投票 / 群接龙 / 群小任务已脱离 notice 假入口
- [x] 群成员低频主动发起群功能第一版：角色可顺势主动发起投票 / 接龙 / 小任务
- [x] 群功能 AI 参与守则第一版：优先角色自身 > 当前群语境 > 关系修饰，避免统一围用户转或失真嘴毒
- [x] 动态主生成链重建：动态开始支持“角色生活型 / 用户关系余波型 / 公开日常型”三类分流
...
- 群聊恢复后的手感和公共场合节奏已完成主链收口，但群生态功能的管理态、节奏态和联动态仍是后续体验主线；
- 群聊主 prompt / scene input 主链乱码已完成清理，但动态及少量历史边角模块仍可能存在旧脏字符串，需要后续继续清账；
- 正式 memory layer 尚未开始完整建设，目前还只是最小双层与投影雏形；
- 群生态功能已经进入第一批真实落地阶段，但距离“真正像微信群 / QQ 群生态”仍有明显差距，后续重点应转向功能管理、自然发起、联动与持续手感。
...
- 群系统消息文案层已清理，群创建 / 入群 / 群资料修改等系统 notice 不再泄漏内部占位符
- 群投票 / 群接龙 / 群小任务第一版已正式落地，且都已脱离 notice 假入口，具备真实卡片体与结束态
- 群成员低频主动发起群功能第一版已接通，群生态开始从“用户手动点按钮”走向“角色也会顺势起头”
- 群投票 / 群接龙 / 群小任务当前都已开始吃分层人设、相关记忆和当前群语境，且默认遵循“角色自身 > 群语境 > 关系修饰”
...
8. 群世界书应晚于关系边界和记忆分层收稳；群投票 / 群接龙 / 群小任务当前已进入第一批真实落地阶段，后续重点应转为功能管理、自然发起和联动
...
- 群世界书仍不应现在插队；群投票、群接龙、群小任务当前已作为第一批群生态功能落地，后续不再是“能不能做”，而是“怎么收成真的群生态”
